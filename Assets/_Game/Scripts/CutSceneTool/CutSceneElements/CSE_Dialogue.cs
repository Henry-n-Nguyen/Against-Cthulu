...
public class CSE_Dialogue : CutSceneElementBase
{
    ...
    private void GatherInput()
    {
        ...
        if (!started)
        {
            ...
            if (isCanInteract && GamePlayManager.Ins.CanInteract && Input.GetButtonDown("Interact"))
            {
                StartDialogue();
            }
        }
    ...
    public override void Execute()
    {
        ...
        dialogueUI = UIManager.Ins.dialogueUI;
    ...
    private void StartDialogue()
    {
        ...
        started = true;
        GamePlayManager.Ins.player.Freeze(true);
        GamePlayManager.Ins.OnUI();
